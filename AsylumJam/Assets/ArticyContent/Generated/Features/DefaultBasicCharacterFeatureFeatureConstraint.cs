...
namespace Articy.Asylumjame.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeatureConstraint
    {
        ...
        private ReferenceStripConstraint mInventory;
        ...
        public ReferenceStripConstraint Inventory
        {
            get
            {
                EnsureConstraints();
        ...
        public virtual void EnsureConstraints()
        {
            ...
            mInventory = new Articy.Unity.Constraints.ReferenceStripConstraint(10000, "Entity;", "", "None;", "InventoryItem;");
        }
    }
}
